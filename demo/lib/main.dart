...
void main() {
  ...
  editableTableEditorController.addListener(chicago.TableViewEditorListener(
    onPreviewEditStarted: (
      chicago.TableViewEditorController controller,
      int rowIndex,
      int columnIndex,
    ) {
      editableTableListButtonController.selectedIndex = editableTableListButtonOptions.indexOf(editableTableData[rowIndex][0]);
      editableTableTextController.text = editableTableData[rowIndex][1];
    ...
    onEditFinished: (
      ...
      if (outcome == chicago.TableViewEditOutcome.saved) {
        editableTableData[editingRowIndex][0] = editableTableListButtonOptions[editableTableListButtonController.selectedIndex];
        editableTableData[editingRowIndex][1] = editableTableTextController.text;
      }
    },
  ));
...
final chicago.TableViewSelectionController editableTableSelectionController =
    chicago.TableViewSelectionController(selectMode: chicago.SelectMode.single);
final chicago.TableViewEditorController editableTableEditorController =
    chicago.TableViewEditorController();
final TextEditingController editableTableTextController = TextEditingController();
final chicago.ListViewSelectionController editableTableListButtonController = chicago.ListViewSelectionController();
const List<String> editableTableListButtonOptions = ['Dog', 'Cat', 'Snake', 'Fish', 'Bird'];
                                                    ...
                                                    child: chicago.ScrollableTableView(
                                                      ...
                                                      columns: [
                                                        ...
                                                        chicago.TableColumnController(
                                                          key: 'icon',
                                                          width:
                                                              chicago.ConstrainedTableColumnWidth(
                                                                  width: 50),
                                                          headerRenderer: ({
                                                            required BuildContext context,
                                                            required int columnIndex,
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: chicago.Border(
                                                    ...
                                                    child: chicago.ScrollableTableView(
                                                      selectionController:
                                                          editableTableSelectionController,
                                                      editorController:
                                                          editableTableEditorController,
                                                      includeHeader: true,
                                                      rowHeight: 23,
                                                          ...
                                                          cellRenderer: ({
                                                            ...
                                                            if (isEditing) {
                                                              return chicago.ListButton<String>(
                                                                ...
                                                                selectionController: editableTableListButtonController,
                                                              );
                                                            } else {
                                                              return Padding(
                                                                padding: EdgeInsets.all(2),
                                                                child: Text(
                                                                  editableTableData[rowIndex]
                                                                      [columnIndex],
                                                                  style: rowSelected
                                                                      ? whiteStyle
                                                                      : baseStyle,
