...
class _RenderRawListButton extends RenderBox
  ...
  void performLayout() {
    ...
    if (child != null) {
      BoxConstraints childConstraints = constraints.deflate(const EdgeInsets.only(left: _kReservedWidth));
        ...
        if (childConstraints.minWidth.isInfinite) {
          ...
          throw FlutterError.fromParts(<DiagnosticsNode>[
            ...
            DiagnosticsProperty<BoxConstraints>(
                ...
                constraints),
            ErrorSpacer(),
            DiagnosticsProperty<Object>('The widget tree that created the ListButton in question was', debugCreator,
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    context.canvas
        .drawLine(offset.translate(_dividerDx + 0.5, 0), offset.translate(_dividerDx + 0.5, size.height), paint);
    ...
    context.canvas
      ..save()
      ..translate(offset.dx + _dividerDx + 1 + pulldownDx, offset.dy + pulldownDy);
    try {
...
class _PopupListState<T> extends State<_PopupList<T>> {
  ...
  ListViewItemDisablerController? _createItemDisabledController() {
    return widget.disabledItemFilter == null ? null : ListViewItemDisablerController(filter: widget.disabledItemFilter);
  }
